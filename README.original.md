...
<img src="./images/redoc-try-out.png"/>
...
`<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/redoc-try-it-out/dist/redoc-do-it.min.js"></script>`
...
<script>
    RedocTryItOut.init('https://petstore.swagger.io/v2/swagger.json', { title: 'Pet Store' }, document.getElementById('redoc_container'));
</script>
```
